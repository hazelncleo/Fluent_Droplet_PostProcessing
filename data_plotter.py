...
df_1 = pd.read_csv('output\\output_data_1000.csv', index_col='timestep_number')
df_075 = pd.read_csv('output\\output_data_750.csv', index_col='timestep_number')
df_05 = pd.read_csv('output\\output_data_500.csv', index_col='timestep_number')
